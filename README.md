...
test two phones without touching a real room. The shared sample workspace stays
apart from real rooms. Demo state uses only `demo:` browser keys and an
isolated sample workspace. See `.factory/demo.md`.
