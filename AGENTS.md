# Kitchen Table: ad-free, account-free classic family board games across phones in the same room or async (`kitchen-table`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://kitchen-table.sociobot.in`. Artifact class: `web-with-backend`.
